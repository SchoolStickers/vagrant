...
sed -i "s/;env[TMP] = .*/env[TMP] = \/tmp/" /etc/php-fpm.d/www.conf
sed -i "s/;env[TMPDIR] = .*/env[TMPDIR] = \/tmp/" /etc/php-fpm.d/www.conf
sed -i "s/;env[TEMP] = .*/env[TEMP] = \/tmp/" /etc/php-fpm.d/www.conf
